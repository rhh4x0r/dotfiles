...
_G.packer_plugins = {
  ["ChatGPT.nvim"] = {
    ...
    loaded = true,
    path = "/Users/max/.local/share/nvim/site/pack/packer/start/ChatGPT.nvim",
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/Users/max/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  playground = {
    loaded = true,
    path = "/Users/max/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/max/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
